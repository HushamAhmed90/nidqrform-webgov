...
window.NID_OWNER = {
  ...
  text: {
    Ara: {
      ...
      strip: 'من إعداد',
      help: 'تحتاج مساعدة في معاملة عراقية أو تصميم؟',
      button: 'راسلني على واتساب',
      message: 'مرحباً، وصلت لك من برنامج استمارة البطاقة الوطنية',
      promo: 'حجز مواعيد لجميع المعاملات العراقية متوفر',
      promoCta: 'اضغط هنا وراسلني على واتساب',
      promoMessage: 'مرحباً، أحتاج حجز موعد لمعاملة عراقية',
      ...
      designCta: 'المصمم هشام احمد • راسلني على واتساب',
      designMessage: 'مرحباً هشام، وصلت لك من برنامج استمارة البطاقة الوطنية وأحتاج تصميم',
      fbButton: 'مجموعة فيسبوك',
      ttButton: 'حساب تيك توك'
    },
    Kur: {
      byline: 'بەرنامەیەکی خۆڕایی، ئامادەکردنی',
      strip: 'ئامادەکردنی',
      help: 'یارمەتیت پێویستە لە مامەڵەیەکی عێراقی یان دیزاین؟',
      button: 'لە واتسئاپ نامەم بۆ بنێرە',
      message: 'سڵاو، لە بەرنامەی فۆرمی کارتی نیشتیمانییەوە هاتووم',
      promo: 'گرتنی ژوان بۆ هەموو مامەڵە عێراقییەکان بەردەستە',
      promoCta: 'کلیک بکە و لە واتسئاپ نامەم بۆ بنێرە',
      promoMessage: 'سڵاو، پێویستم بە گرتنی ژوانە بۆ مامەڵەیەکی عێراقی',
      ...
      designCta: 'دیزاینەر هیشام ئەحمەد • لە واتسئاپ نامەم بۆ بنێرە',
      designMessage: 'سڵاو هیشام، لە بەرنامەی فۆرمی کارتی نیشتیمانییەوە هاتووم و پێویستم بە دیزاینە',
      fbButton: 'گرووپی فەیسبووک',
      ttButton: 'هەژماری تیکتۆک'
    }
  }
};
